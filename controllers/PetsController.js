...
class PetsController {
    ...
    static register = async (req, res, next) => {
        try {
            const { email, realPassword, password, confirmPassword, name, petName, petYears} = req.body;
    ...
    static contactPage = (req, res, next) => {
        try {
            ...
            res.render('pets/contact', {
                ...
                iemailsVisible: true,
                iname: "Lyova",
                iemails: ["mixail.slepov@gmail.com", "lyova.poghosyan2@gmail.com", "lyova.poghosyan3@gmail.com"],
                iphone: "+486524485",
                ipassword: '123456789',
